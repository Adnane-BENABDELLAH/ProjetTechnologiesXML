            ...
            <fo:page-sequence master-reference="simple">
                <fo:flow flow-name="xsl-region-body">
                    <fo:block font-size="16pt"
                        ...
                        line-height="20pt"
                        text-align="center"
                        margin-bottom="0.5cm">RELEVÉ DE NOTES DE AHMED BASSOU</fo:block>
                    <fo:block>
                                ...
                                <fo:table-row background-color="green">
                                    ...
                                    <fo:table-cell padding="10pt" border="1pt solid black">
                                        <fo:block text-align="center" font-weight="bold">
                                            <xsl:value-of select="((//Module[1]/@Moyenne) + (//Module[2]/@Moyenne) + (//Module[3]/@Moyenne) + (//Module[4]/@Moyenne)) div 4"/>
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
